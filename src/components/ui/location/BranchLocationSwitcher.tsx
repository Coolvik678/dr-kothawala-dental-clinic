...
export function BranchLocationSwitcher() {
  ...
  return (
    <div className="w-full rounded-3xl border border-teal-500/30 bg-slate-900/90 p-6 backdrop-blur-2xl shadow-2xl">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/10 pb-5">
        ...
        <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-slate-950 p-1.5">
          {branches.map((b) => (
            <button
              key={b.id}
      ...
      >
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-teal-950 border border-teal-500/40 text-teal-400 flex-shrink-0">
            ...
            <div>
              ...
              <span className="inline-block mt-2 text-[11px] font-semibold text-teal-400">
        ...
        {/* Action card */}
        <div className="rounded-2xl border border-white/10 bg-slate-950/80 p-5 flex flex-col justify-between space-y-4">
          <div className="flex items-center justify-between">
            <span className="flex items-center gap-1.5 text-xs font-bold text-emerald-400">
              <CheckCircle className="h-4 w-4" /> Live Status: Open Today
            </span>
            <span className="rounded-full bg-teal-950 px-2.5 py-0.5 text-[10px] font-bold text-teal-300 border border-teal-500/30">
              Verified Location
            </span>
          </div>
          ...
          <a
            ...
            className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-teal-600 hover:bg-teal-500 text-white font-bold text-xs shadow-lg shadow-teal-500/20 transition-all cursor-pointer"
          >
            <Navigation className="h-4 w-4" /> Get 1-Click Google Maps Directions <ExternalLink className="h-3.5 w-3.5" />
          </a>
        </div>
      </motion.div>
    </div>
